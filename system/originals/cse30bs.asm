;        .TITLE  'COMPUSTAR M30 STAND-ALONE BIOS VER 2.0 FOR CPM VER 2.2 (CSE30BS.ASM) 5/5/82'
;
;
...
;
;
;          COMPUSTAR MODEL 30 STAND-ALONE BIOS INTERFACE
;
;
;**************************************************************************
;
...
sgnon:
;
        DB      'COMPUSTAR M30 STAND-ALONE DOS VER 2.0, FOR CP/M 2.2',0AH,0DH,80H
;
;
;
;
