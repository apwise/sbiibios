...
;;;
        ...
        sta     8a0bh   ;0050 32 0b 8a         sta 8a0bh
...
;;; 
        ...
        jmp     c287h   ;0403 c3 87 c2         jmp c287h
        di              ;0406 f3               di 
...
;;; 
        lxi     h, c0abh (message)        ;0497 21 ab c0         lxi h, c0abh
        call    c09eh           ;049a cd 9e c0         call c09eh
        ret                     ;049d c9               ret
;;;
lp5:    mov     a, m    ;049e 7e               mov a, m 
        push    h       ;049f e5               push h 
        call    c11eh   ;04a0 cd 1e c1         call c11eh
        pop     h       ;04a3 e1               pop h 
        mov     a, m    ;04a4 7e               mov a, m 
        ora     a       ;04a5 b7               ora a 
        rm              ;04a6 f8               rm 
        inx     h       ;04a7 23               inx h 
        jmp     lp5     ;04a8 c3 9e c0         jmp c09eh
;;;
        ...
        db      'A'+0x80
;;;
        lxi     b, ff00h        ;04cd 01 00 ff         lxi b, ff00h
        call    c298h   ;04d0 cd 98 c2         call c298h
        call    c2ddh   ;04d3 cd dd c2         call c2ddh
        call    c2d1h   ;04d6 cd d1 c2         call c2d1h
        ani     80h     ;04d9 e6 80            ani 80h
        jz      L001    ;04db ca f2 c0         jz c0f2h
        call    c097h   ;04de cd 97 c0         call c097h
lp6:    lxi     b, 0000h        ;04e1 01 00 00         lxi b, 0000h
        call    c298h   ;04e4 cd 98 c2         call c298h
        call    c2ddh   ;04e7 cd dd c2         call c2ddh
        call    c2d1h   ;04ea cd d1 c2         call c2d1h
        ani     80h     ;04ed e6 80            ani 80h
        jnz     lp6     ;04ef c2 e1 c0         jnz c0e1h
L001:   lxi     h, c780h        ;04f2 21 80 c7         lxi h, c780h
        lxi     d, 0001h        ;04f5 11 01 00         lxi d, 0001h
        lxi     b, 0100h        ;04f8 01 00 01         lxi b, 0100h
        call    c287h   ;04fb cd 87 c2         call c287h
        jmp     c780h   ;04fe c3 80 c7         jmp c780h
;;;
...
;;; 
        ...
        ret             ;0576 c9               ret
;;; 
 ;0577 32 0d c3         sta c30dh
 ;057a cd 91 c1         call c191h
 ;057d 7e               mov a, m 
 ;057e b7               ora a 
 ;057f cc fc c1         cz c1fch
 ;0582 2a 07 c3         lhld c307h
 ;0585 7c               mov a, h 
 ;0586 f6 f8            ori f8h
 ;0588 67               mov h, a 
 ;0589 3a 0d c3         lda c30dh
 ;058c 77               mov m, a 
 ;058d cd 37 c2         call c237h
 ;0590 c9               ret 
 ;0591 21 29 c3         lxi h, c329h
 ;0594 16 00            mvi d, 00h
 ;0596 3a 06 c3         lda c306h
 ;0599 5f               mov e, a 
 ;059a 19               dad d 
 ;059b c9               ret 
 ;059c f3               di 
 ;059d 2a 0b c3         lhld c30bh
 ;05a0 11 50 00         lxi d, 0050h
 ;05a3 19               dad d 
 ;05a4 22 0b c3         shld  c30bh
 ;05a7 21 2a c3         lxi h, c32ah
 ;05aa 11 29 c3         lxi d, c329h
 ;05ad 01 18 00         lxi b, 0018h
 ;05b0 ed b0 3e         call 3eb0h
 ;05b3 00               nop 
 ;05b4 12               stax d 
 ;05b5 fb               ei 
 ;05b6 c9               ret 
 ;05b7 21 ca c1         lxi h, c1cah
 ;05ba 3a 06 c3         lda c306h
 ;05bd 07               rlc 
 ;05be 5f               mov e, a 
 ;05bf 16 00            mvi d, 00h
 ;05c1 19               dad d 
 ;05c2 5e               mov e, m 
 ;05c3 23               inx h 
 ;05c4 56               mov d, m 
 ;05c5 2a 0b c3         lhld c30bh
 ;05c8 19               dad d 
 ;05c9 c9               ret 
 ;05ca 00               nop 
 ;05cb 00               nop 
 ...
 ;05fa 80               add b 
 ;05fb 07               rlc 
 ;05fc cd b7 c1         call c1b7h
 ;05ff 16 50            mvi d, 50h
 ;0601 3e f8            mvi a, f8h
 ;0603 b4               ora h 
 ;0604 67               mov h, a 
 ;0605 36 20            mvi m, 20h
 ;0607 23               inx h 
 ;0608 15               dcr d 
 ;0609 c2 01 c2         jnz c201h
 ;060c cd 91 c1         call c191h
 ;060f 36 ff            mvi m, ffh
 ;0611 c9               ret 
 ;0612 2a 0b c3         lhld c30bh
 ;0615 22 09 c3         shld  c309h
 ;0618 eb               xchg 
 ;0619 2a 07 c3         lhld c307h
 ;061c 7c               mov a, h 
 ;061d e6 0f            ani 0fh
 ;061f 67               mov h, a 
 ;0620 7a               mov a, d 
 ;0621 e6 0f            ani 0fh
 ;0623 57               mov d, a 
 ;0624 3e 01            mvi a, 01h
 ;0626 d3 6b            out 6bh
 ;0628 3e 03            mvi a, 03h
 ;062a 77               mov m, a 
 ;062b 3e 01            mvi a, 01h
 ;062d eb               xchg 
 ;062e 77               mov m, a 
 ;062f 3e 02            mvi a, 02h
 ;0631 77               mov m, a 
 ;0632 3e 00            mvi a, 00h
 ;0634 d3 6b            out 6bh
 ;0636 c9               ret 
 ;0637 2a 07 c3         lhld c307h
 ;063a 23               inx h 
 ;063b 22 07 c3         shld  c307h
 ;063e 2a 05 c3         lhld c305h
 ;0641 2c               inr l 
 ;0642 7d               mov a, l 
 ;0643 fe 50            cpi 50h
 ;0645 c2 59 c2         jnz c259h
 ;0648 2e 00            mvi l, 00h
 ;064a 7c               mov a, h 
 ;064b fe 18            cpi 18h
 ;064d c2 58 c2         jnz c258h
 ;0650 e5               push h 
 ;0651 cd 9c c1         call c19ch
 ;0654 e1               pop h 
 ;0655 c3 59 c2         jmp c259h
 ;0658 24               inr h 
 ;0659 22 05 c3         shld  c305h
 ;065c c9               ret 
 ;065d 2a 07 c3         lhld c307h
 ;0660 11 50 00         lxi d, 0050h
 ;0663 19               dad d 
 ;0664 22 07 c3         shld  c307h
 ;0667 3a 06 c3         lda c306h
 ;066a fe 18            cpi 18h
 ;066c c2 76 c2         jnz c276h
 ;066f 32 06 c3         sta c306h
 ;0672 cd 9c c1         call c19ch
 ;0675 c9               ret 
 ;0676 3c               inr a 
 ;0677 32 06 c3         sta c306h
 ;067a c9               ret 
 ;067b cd b7 c1         call c1b7h
 ;067e 22 07 c3         shld  c307h
 ;0681 3e 00            mvi a, 00h
 ;0683 32 05 c3         sta c305h
 ;0686 c9               ret 
 ;0687 e5               push h 
 ;0688 cd 98 c2         call c298h
 ;068b cd dd c2         call c2ddh
 ;068e e1               pop h 
 ;068f cd c1 c2         call c2c1h
 ;0692 cd d1 c2         call c2d1h
 ;0695 e6 01            ani 01h
 ;0697 c9               ret 
 ;0698 cd ec c2         call c2ech
 ;069b 21 02 88         lxi h, 8802h
 ;069e 70               mov m, b 
 ;069f 23               inx h 
 ;06a0 71               mov m, c 
 ;06a1 23               inx h 
 ...
 ;06a7 2f               cma 
 ;06a8 77               mov m, a 
 ;06a9 3e ff            mvi a, ffh
 ;06ab 32 07 88         sta 8807h
 ;06ae cd fb c2         call c2fbh
 ;06b1 c9               ret 
 ;06b2 cd ec c2         call c2ech
 ;06b5 11 08 88         lxi d, 8808h
 ;06b8 01 00 02         lxi b, 0200h
 ;06bb ed b0 cd         call cdb0h
 ;06be fb               ei 
 ;06bf c2 c9 cd         jnz cdc9h
 ;06c2 ec c2 eb         cpe ebc2h
 ;06c5 21 08 88         lxi h, 8808h
 ;06c8 01 00 02         lxi b, 0200h
 ;06cb ed b0 cd         call cdb0h
 ;06ce fb               ei 
 ;06cf c2 c9 cd         jnz cdc9h
 ;06d2 ec c2 3a         cpe 3ac2h
 ;06d5 0b               dcx b 
 ;06d6 8a               adc d 
 ;06d7 f5               push psw 
 ;06d8 cd fb c2         call c2fbh
 ;06db f1               pop psw 
 ;06dc c9               ret 
 ;06dd db 69            in 69h
 ;06df e6 20            ani 20h
 ;06e1 ca dd c2         jz c2ddh
 ;06e4 db 69            in 69h
 ;06e6 e6 20            ani 20h
 ;06e8 c2 e4 c2         jnz c2e4h
 ;06eb c9               ret 
 ;06ec 3e 0a            mvi a, 0ah
 ;06ee d3 6b            out 6bh
 ;06f0 db 69            in 69h
 ;06f2 17               ral 
 ;06f3 da f0 c2         jc c2f0h
 ;06f6 3e 08            mvi a, 08h
 ;06f8 d3 6b            out 6bh
 ;06fa c9               ret 
 ;06fb 3e 09            mvi a, 09h
 ;06fd d3 6b            out 6bh
 ;06ff 3e 0b            mvi a, 0bh
 ;0701 d3 6b            out 6bh
 ;0703 c9               ret 
